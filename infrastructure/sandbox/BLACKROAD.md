...
<p align="center"><strong>OpenSandbox</strong> — agents</p>
...
This project is a fork of [alibaba/OpenSandbox](https://github.com/alibaba/OpenSandbox), licensed under **MIT**.
...
| **Category** | agents |
| **Upstream** | [alibaba/OpenSandbox](https://github.com/alibaba/OpenSandbox) |
